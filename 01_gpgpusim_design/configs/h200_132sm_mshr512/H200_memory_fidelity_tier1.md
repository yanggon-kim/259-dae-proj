...
A skeptical follow-up to the RFQ-based queue results ("how can fewer warps be faster?")
uncovered a confound:

1. The RFQ depth-sweep "deeper RFQ queue -> faster" was **not** producer/consumer
...
3. **Regenerate prior cycle metrics:** all baseline, warp-specialized, and RFQ-based runs before this change used the
