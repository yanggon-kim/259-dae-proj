...
void print_result(float ms, size_t n, int compute_iters,
    ...
    std::printf("stream_fma_v6_variant2 time_ms=%8.4f  global_GB/s=%8.2f  "
...
int main(int argc, char** argv) {
    ...
    if (opt.n % elements_per_cta != 0) {
        std::fprintf(stderr,
                     "Unsafe n=%zu for full-tile stream_fma_v6_variant2. "
